...
class Jobexecutionlog(models.Model):
    ...
    #__Jobexecutionlog_FIELDS__
    id = models.IntegerField(null=True, blank=True)
    executed_at = models.DateTimeField(blank=True, null=True, default=timezone.now)
    output = models.TextField(max_length=255, null=True, blank=True)
    error = models.TextField(max_length=255, null=True, blank=True)
    job_id = models.IntegerField(null=True, blank=True)

    #__Jobexecutionlog_FIELDS__END

    class Meta:
        verbose_name        = _("Jobexecutionlog")
        verbose_name_plural = _("Jobexecutionlog")
